...
#include "APWBLuiTwoFluidIsothermal.hpp"

// Self-register with the factory
#include "TimeMethodRegistrar.hpp"
REGISTER_TIMEMETHOD("APWBLuiTwoFluidIsothermal", APWBLuiTwoFluidIsothermal);
...
void APWBLuiTwoFluidIsothermal::setup(){
...
double APWBLuiTwoFluidIsothermal::velocityFlux(const CellDataRef uL, const CellDataRef uR) {
    ...
    double M_o    = sqrt(min(1., max(Mach12*Mach12, M_co*M_co)));
    //double fa     = sqrt((1 - M_o*M_o)*(1 - M_o*M_o)*Mach12*Mach12 + 4*M_o*M_o)/(1 + M_o*M_o);
    //double fa = M_o*(2 - M_o);
    double fa = (M_o*M_o + M_o)/(M_o*M_o + 1);
    
    return 0.5*(v_eL + v_eR) - 0.5*sqrt(MASSRATIO)*fa*(1./n_eR - 1./n_eL)*(n_eR + n_eL)/2.;
    
}

double APWBLuiTwoFluidIsothermal::pressureFlux(const CellDataRef uL, const CellDataRef uR) {
...
double APWBLuiTwoFluidIsothermal::densityNumericalViscosity(const double niP1,const double ni, const double niM1){
...
void APWBLuiTwoFluidIsothermal::computeElectronDensity()
{
    setBoundaries();
...
void APWBLuiTwoFluidIsothermal::computeElectricPotential(){
...
void APWBLuiTwoFluidIsothermal::computeElectronVelocity(){
...
void APWBLuiTwoFluidIsothermal::computeEulerianStep(){
...
double APWBLuiTwoFluidIsothermal::computeIonizationConstant(){
...
// Non WB version
//void APWBLuiTwoFluidIsothermal::computeSources(){
//    vector<Cell1D>& cells = MeshData::getInstance().getData<Cell1D>("Cells");
//    double* source = MeshData::getInstance().get2DData<double>("source").mutable_data(0,0);
//    
//    
...
double APWBLuiTwoFluidIsothermal::WBmassSourceL(const double u_12, const double c_12){
...
double APWBLuiTwoFluidIsothermal::WBmassSourceR(const double u_12, const double c_12){
...
double APWBLuiTwoFluidIsothermal::WBmomSourceL(const double u_12, const double c_12){
...
double APWBLuiTwoFluidIsothermal::WBmomSourceR(const double u_12, const double c_12){
...
void APWBLuiTwoFluidIsothermal::setBoundaries(){
...
void APWBLuiTwoFluidIsothermal::computeIonFlux(){
...
void APWBLuiTwoFluidIsothermal::takeStep(double dt){
    APWBLuiTwoFluidIsothermal::takeStep();
}

void APWBLuiTwoFluidIsothermal::takeStep()
{
