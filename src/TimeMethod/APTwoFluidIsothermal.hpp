...
#ifndef APTwoFluidIsothermal_hpp
#define APTwoFluidIsothermal_hpp
...
class APTwoFluidIsothermal : public TimeMethod
{
public:
    APTwoFluidIsothermal(string name) : TimeMethod(name), u_1(NBEQS*NBCELLS), m_A(NBCELLS,vector<double>(NBCELLS,0.)), m_B(NBCELLS, 0.), m_gradPhi(NBCELLS,0.), m_inverseDensity(NBCELLS,1.), m_density_nP1Minus(NBCELLS, 0.), m_momentum_nP1Minus(NBCELLS, 0.),m_density_nP1(NBCELLS, 0.), m_momentum_nP1(NBCELLS, 0.), m_velocity(NBCELLS, 0.){
...
#endif /* APTwoFluidIsothermal_hpp */
