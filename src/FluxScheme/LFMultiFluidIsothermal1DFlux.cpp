//
//  LFMultiFluidIsothermal1DFlux.cpp
//  Muffin
//
...
#include "LFMultiFluidIsothermal1DFlux.hpp"
#include "FluxSchemeRegistrar.hpp"
#include <cmath>
using namespace std;

REGISTER_FLUXSCHEME("LFMultiFluidIsothermal1D", LFMultiFluidIsothermal1DFlux);

vector<double>& LFMultiFluidIsothermal1DFlux::operator()(const CellDataRef uL, const CellDataRef uR)
{
