//
//  HLLEulerIsothermalScaled1DFlux.cpp
//  Muffin
//
...
#include "HLLEulerIsothermalScaled1DFlux.hpp"
#include "FluxSchemeRegistrar.hpp"

REGISTER_FLUXSCHEME("HLLEulerIsothermalScaled1D", HLLEulerIsothermalScaled1DFlux);

vector<double>& HLLEulerIsothermalScaled1DFlux::operator()(const CellDataRef uL, const CellDataRef uR)
{
